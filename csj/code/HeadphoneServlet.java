...
public class HeadphoneServlet extends HttpServlet {
	...
	out.println(" </ul>"+
			...
			"<div id='body'>"+
				"<section id='content'>"+
					"<article>"+
						"<h2 align='center'>Welcome to Headphones Station</h2>"+
					"</article>"+
					"<article class='expanded'>"+					
						"<table>"+
						"<tr>"+
						"<th colspan='3'>"+
						"<h2 align='center'>List of headphones</h2>"+
						"</th>"+
						"</tr>");
		...
		for (ProductCatalog pc : hm.values()) 
		{
			...
			// checks for null
			else if ((itemId == "" || itemId == null) && pc.getId().startsWith("hp")) 
			{
