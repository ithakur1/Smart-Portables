...
public class ViewAllProductsServlet extends HttpServlet {
	...
	"<ul class='nav navbar-nav navbar-right'>"+
		...
		prods = ms.viewProductsDetails();
		
			out.println("<table>");
			
			out.print("<tr><td>Product Name: </td><td>Product Price in $:</td><td>Quantity:</td></tr>");
			for(Product prd : prods){		
			out.print("<tr><td>" + prd.getProdName() + "</td><td>" + prd.getProdType() 
							+ "</td><td>"+ prd.getQuantity() +"</td><td align='center'><form method = 'post' action = 'DeleteProductServlet'>"
									+ "<input type='hidden' name = 'productName' value='"+prd.getProdName()+"'/>"
									+ "<input type = 'submit' name = 'Delete' value = 'Delete'></form></td>"
									+"<td align='center'><form method = 'post' action = 'UpdateProductServlet'>"
									+ "<input type='hidden' name = 'productName' value='"+prd.getProdName()+"'/>"
