...
@WebServlet("/ViewProductOnSale")
public class ViewProductOnSale extends HttpServlet {
	...
	"<ul class='nav navbar-nav navbar-right'>"+
		...
		out.println(" </ul>" + "</nav>" +
				...
				"<div id='body'>" + "<section id='content'>" + "<article>" +
				 "<h2 align='center'>List of Products on Sale</h2>"+
