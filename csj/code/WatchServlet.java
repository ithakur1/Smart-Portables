...
public class WatchServlet extends HttpServlet {
		...
		"<div id='container'>"+
			...
			"<div class='navbar-header'>"+
			    ...
			    "<div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'>"+
			     ...
			     // "<li class='end'><a href='Buy'>Cart("+CartCount()+")</a></li></ul></nav><div id='page'>"+
	...
	out.println(" </ul>"+
			...
			"<div id='body'>"+
				"<section id='content'>"+
					"<article>"+
						"<h2 align='center'>Welcome to Watch Station</h2>"+
					"</article>"+
					"<article class='expanded'>"+					
						"<table>"+
						"<tr>"+
						"<th colspan='3'>"+
						"<h2 align='center'>List of watches</h2>"+
						"</th>"+
						"</tr>");
		...
		for (ProductCatalog pc : hm.values()) 
		{
			...
			// checks for null
			else if ((itemId == "" || itemId == null) && pc.getId().startsWith("sw")) 
			{
